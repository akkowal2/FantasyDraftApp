...
public class TestRequests {
	...
	public void AcreateLeague() {
		...
		WebTarget con = base.path("StartConnection/OpenConnections/leagueTest1/pass");
	...
	public void BaddConnection(){
		...
		WebTarget con = base.path("StartConnection/Connect/leagueTest1/pass/Team1");
	...
	public void DgetTeams(){
		...
		WebTarget con = base.path("StartConnection/GetTeams/leagueTest1");
	...
	public void CcloseConnections(){
		...
		WebTarget con = base.path("StartConnection/CloseConnections/leagueTest1/pass");
